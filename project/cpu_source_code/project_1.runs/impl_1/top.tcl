...
set rc [catch {
  ...
  add_files -quiet {{G:/Notes/Computer Organization/Proj/fin/cpu_4/project_1.runs/synth_1/top.dcp}}
  ...
  read_edif {{g:/Notes/Computer Organization/Proj/fin/cpu_4/project_1.srcs/sources_1/ip/uart_bmpg_0_1/uart_bmpg.edif}}
